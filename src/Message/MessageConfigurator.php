...
final class MessageConfigurator implements ConfiguratorInterface
{
    /**
    ...
    {
        $this->subManagerConfigurator = new SubManagerConfigurator(MessageSubManager::class, MessageInterface::class);
    }
     ...
     */
    public function addMessage(string $action, string $factory = AutowireFactory::class): void
    {
