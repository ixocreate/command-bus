...
class ConsumeCommand extends Command implements CommandInterface
{
    protected $consumer;
    protected $queues;
     ...
     * @param PersistentFactory $queues
     */
    public function __construct(Consumer $consumer, PersistentFactory $queues)
    {
